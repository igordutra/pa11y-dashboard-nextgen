...
- **Security & Sandboxing**:
    ...
    - **Rate Limiting**: Global API limits (1000 req/min) and strict scan trigger limits (10 req/min) using `@fastify/rate-limit`. Static assets are excluded from rate limiting.
